#!/bin/bash
#Develop a shell script - /home/bob/deploy-ecommerce-application.sh - to automate the
# deployment of the KodeKloud E-Commerce Application. Click on the tab called documentation on
# the top-right of the terminal.
#You may view the web application to verify by clicking on the KodeKloud E-Commerce Application
# tab at the top of your terminal. Ensure the web application is accessible visible and it lists
# all products. repo reference: https://github.com/kodekloudhub/learning-app-ecommerce
...
print_color "green" "Updatin g index.php.."
