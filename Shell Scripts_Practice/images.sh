#We have some images under the directory /home/bob/images. Develop a script /home/bob/rename-images.sh
# to rename all files within the images folder that has extension jpeg to jpg.
